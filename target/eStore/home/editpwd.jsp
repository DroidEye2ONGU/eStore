...
<div class="container4">
    <div class="register_box">
        <div class="head">
            <!-- 此处需要改链接 -->
            <h3><a href="/home/userinfo.jsp">个人信息</a>&nbsp;&nbsp;&nbsp;修改密码</h3>
        </div>
        <div class="security">
            ...
            <form action="/UserChangePasswordServlet" method="post">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <input id="J_euserName" class="long" name="oldpassword" value=""
                               type="password"/>
                    ...
                    <li>
                        ...
                        <input id="J_euserName" class="long" name="newpassword" value=""
                               type="password"/>
                        <span id="J_eUserNameTipImg" class="icon"></span>
                        <div id="J_eUserNameTipInfo" class="ltip"></div>
                        <span class="placeholder"
                    ...
                    <li>
                        ...
                        <input id="J_euserName" class="long" name="repassword" value=""
                               type="password"/>
                        <span id="J_eUserNameTipImg" class="icon"></span>
                        <div id="J_eUserNameTipInfo" class="ltip"></div>
                        <span class="placeholder"
